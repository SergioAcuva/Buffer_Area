...
class area_buffer:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Generador Buffer')

        # Check if plugin was started the first time in current QGIS session
        # Must be set in initGui() to survive plugin reloads
        self.first_start = None
        self.dlg = area_bufferDialog(self.iface, parent=None)
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('area_buffer', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/generador_buffer/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Generador de Buffer'),
            callback=self.run,
